...
class Layout extends PureComponent {
  ...
  componentDidMount() {
    ...
    this.mytimeLineCubes
      ...
      .to(this._cubeLG, 80, { x: widthV, y: 0.90 * heightV, repeat: -1, yoyo: true }, 0)
      ...
      .from(this._cubeSMRotate1, 60, { repeat: -1, x: widthV, yoyo: true }, "-=60")
      .to(this._cubeSMRotate1, 60, { x: 0.9 * widthV, y: 0.1 * heightV, repeat: -1, yoyo: true }, 0)
      .from(this._cubeSMRotate2, 60, { repeat: -1, y: 0.6 * heightV, x: 0.9 * widthV, yoyo: true }, "-=60")

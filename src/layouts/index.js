...
class Layout extends PureComponent {
  ...
  componentDidMount() {
    ...
    this.mytimeLineCubes
      .from(this._cubeXL, .5, {scale: 0, opacity: 0, y: 0.40 * windowHeight, x: 0.78 * windowWidth,})
      .from(this._cubeXL, 80, {repeat:-1, yoyo: true})
      .to(this._cubeXL, 80, {x: 0.10 * windowHeight, y: 0,  repeat:-1, yoyo: true}, 0)
      .from(this._cubeMD, .5, {scale: 0, opacity: 0, y: 0.36 * windowHeight, x: 0.69 * windowWidth}, "-=80")
      .from(this._cubeMD, 90, {repeat:-1, yoyo: true}, "-=80")
      .to(this._cubeMD, 90, {x: 0.28 * windowWidth, y: 0.90 * windowHeight,  repeat:-1, yoyo: true}, 0)
      .from(this._cubeLG, .5, {scale: 0, opacity: 0,},"-=90")
      ...
      .from(this._cubeSM, .5, {scale: 0, opacity: 0,},"-=80")
      .from(this._cubeSM, 40, {repeat: -1, y: 0.2 * windowHeight, x: 0.9 * windowWidth, yoyo: true}, "-=64")
      .to(this._cubeSM, 40, {x: 0.1 * windowWidth, y: 0.9* windowHeight,  repeat:-1, yoyo: true}, 0)
      .from(this._cubeSMRotate, .5, {scale: 0, opacity: 0,},"-=40")
      ...
      .from(this._cubeSMRotate1, .5, {scale: 0, opacity: 0,},"-=60")
      ...
      .from(this._cubeSMRotate2, .5, {scale: 0, opacity: 0,},"-=60")
